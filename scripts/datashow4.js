 ...
 let search_term = document.getElementById("search").value;
  ...
  async function apicalling(){
      try{
        ...
        let res=await fetch(`http://makeup-api.herokuapp.com/api/v1/products.json?product_type=eyebrow`)
...
async function filterRating(){
 ...
 //filetr by itemsfilter

//let selected211=document.getElementById("itemsfilter").value;
function apicalling22(){
    let selected2=document.getElementById("itemsfilter").value;
    ...
    async function apicalling(){
     appendingcont.innerHTML=""
       try{
         ...
         let res=await fetch(`http://makeup-api.herokuapp.com/api/v1/products.json?product_category=${selected2}&product_type=blush`)
         let data=await res.json();
       //  console.log(data);
         appendData(data);
       }catch(err){
    ...
    //  document.getElementById("button2").addEventListener("click", callfunction2)
    //  function callfunction2(){
    //  //   appendingcont.innerHTML="";
    //     console.log(selected211)
    //  }
    
    function apicalling221(){
         let selected221=document.getElementById("tagfilter").value;
        let appendingcont=document.querySelector(".landing-container2");
        apicalling();
       async function apicalling(){
         appendingcont.innerHTML=""
           try{
             ...
             let res=await fetch(`http://makeup-api.herokuapp.com/api/v1/products.json?product_tags=${selected221}&product_type=blush`)
             let data=await res.json();
           //  console.log(data);
             appendData(data);
           }catch(err){
